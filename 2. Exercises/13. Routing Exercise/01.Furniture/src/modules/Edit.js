...
import {getItem, updateFurniture} from "../api/data.js";
...
export class Edit extends View {
    ...
    async prepareView(id) {
        ...
        const temp = (errObj) => html`
            <div class="container">
                ...
                <form @submit=${this.edit.bind(null, id, this.root, temp)}>
                    ${errObj ? html`
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input class=${errObj ? 'form-control' + (errObj && errObj.errors.description ? ' is-invalid' : ' is-valid') : 'form-control'}
                                       ...
                                       value="Medium table" .value=${item.description}>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class=${errObj ? 'form-control' + (errObj && errObj.errors.price ? ' is-invalid' : ' is-valid') : 'form-control'}
                                       id="new-price" type="number" name="price" value="235"
                                       .value=${item.price}>
                            </div>
                            <div class="form-group">
                                ...
                                <input class=${errObj ? 'form-control' + (errObj && errObj.errors.img ? ' is-invalid' : ' is-valid') : 'form-control'}
                                       ...
                                       value="/images/table.png" .value=${item.img}>
                            </div>
                            <div class="form-group">
    ...
    async edit(id, root, temp, event) {
        ...
        const furniture = await updateFurniture(id, item);
